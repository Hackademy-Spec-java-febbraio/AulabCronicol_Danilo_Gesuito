...
import it.aulab.progetto_finale_danilo_gesuito.repositories.ImageRepository;
import it.aulab.progetto_finale_danilo_gesuito.utils.StringManipulation;
...
public class ImageServiceImpl implements ImageService {
    ...
    public void saveImageOnDB(String url, Article article) {
        url.replace(supabaseBucket, supabaseImage);
